...
const translations = {
  ar: {
    ...
    editor: 'محرر',
    admin: 'مدير',
    viewerDesc: 'يمكنك رؤية الشجرة والبحث في الأعضاء',
    editorDesc: 'يمكنك إضافة وتعديل أفراد العائلة',
    adminDesc: 'صلاحيات كاملة بما في ذلك دعوة الآخرين',
    accept: 'قبول الدعوة',
    decline: 'رفض',
  ...
  en: {
    ...
    editor: 'Editor',
    admin: 'Admin',
    viewerDesc: 'You can view the tree and search members',
    editorDesc: 'You can add and edit family members',
    adminDesc: 'Full access including inviting others',
...
const roleDescriptions = {
  ar: {
    viewer: 'يمكنك رؤية الشجرة والبحث في الأعضاء',
    editor: 'يمكنك إضافة وتعديل أفراد العائلة',
    admin: 'صلاحيات كاملة بما في ذلك دعوة الآخرين',
  },
  en: {
    viewer: 'You can view the tree and search members',
    editor: 'You can add and edit family members',
